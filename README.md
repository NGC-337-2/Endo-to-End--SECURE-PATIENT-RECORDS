...
Stored encrypted in database using AES algorithm. Returned decrypted in API responses.
...
2. Configured Spring Boot SSL
3. Enabled HTTPS port 8443
...
**Realm created:** `healthcare`

**Client created:** `patient-api`
...
Project hosted at: [https://github.com/Noelsiby/patient-service-backend](https://github.com/Noelsiby/patient-service-backend)
...
Returned values are decrypted automatically.
